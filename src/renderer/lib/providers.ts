...
export const PRESET_PROVIDERS: Array<{
  ...
  { id: 'kimi', name: 'Kimi (Moonshot)', provider: 'openai', baseUrl: 'https://api.moonshot.cn/v1', models: ['kimi-latest', 'kimi-k1'], testable: true },
  { id: 'kimi-code', name: 'Kimi Code', provider: 'anthropic', baseUrl: 'https://api.kimi.com/coding', models: ['kimi-for-coding'], testable: true },
  { id: 'glm', name: '智谱 GLM', provider: 'openai', baseUrl: 'https://open.bigmodel.cn/api/paas/v4', models: ['glm-4', 'glm-4-flash'], testable: true },
