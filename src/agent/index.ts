...
export { AppendFileTool } from './tools/impl/appendFile'
...
export { WordBatchSetTool } from './tools/impl/wordBatchSet'
export { CreateDocumentTool } from './tools/impl/createDocument'
